...
public class UserAgentTest {
    /**
     * Copy of {@link AppInitializer#USER_AGENT_APPNAME}.
    ...
    public void testGetDefaultUserAgent() {
        String defaultUserAgent = AppInitializer.Companion.getDefaultUserAgent();
    ...
    public void testGetUserAgent() {
        String userAgent = AppInitializer.Companion.getUserAgent();
