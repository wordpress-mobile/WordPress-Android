...
public class WPCheckedTextView extends AppCompatCheckedTextView {
    public WPCheckedTextView(Context context) {
        super(context);
    }

    public WPCheckedTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        readCustomAttrs(context, attrs);
    }

    public WPCheckedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
