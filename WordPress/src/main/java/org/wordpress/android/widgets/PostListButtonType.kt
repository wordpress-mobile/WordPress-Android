...
enum class PostListButtonType constructor(
    ...
    BUTTON_EDIT(1, R.string.button_edit, R.drawable.ic_pencil_white_24dp, R.attr.wpColorTextSubtle),
    BUTTON_VIEW(2, R.string.button_view, R.drawable.ic_external_white_24dp, R.attr.wpColorTextSubtle),
    BUTTON_PREVIEW(3, R.string.button_preview, R.drawable.ic_external_white_24dp, R.attr.wpColorTextSubtle),
    BUTTON_STATS(4, R.string.button_stats, R.drawable.ic_stats_alt_white_24dp, R.attr.wpColorTextSubtle),
    BUTTON_TRASH(5, R.string.button_trash, R.drawable.ic_trash_white_24dp, R.attr.wpColorTextSubtle),
    BUTTON_DELETE(6, R.string.button_delete, R.drawable.ic_trash_white_24dp, R.attr.wpColorTextSubtle),
    BUTTON_PUBLISH(7, R.string.button_publish, R.drawable.ic_reader_white_24dp, R.attr.wpColorTextSubtle),
    BUTTON_SYNC(8, R.string.button_sync, R.drawable.ic_reader_white_24dp, R.attr.wpColorTextSubtle),
