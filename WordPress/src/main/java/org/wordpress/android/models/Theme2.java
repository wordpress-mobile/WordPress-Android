...
public class Theme2 {
    ...
    public Theme2(String themeId, String screenshotURL, String name, String description, int trendingRank, int popularityRank, String launchDate, String blogId, String previewURL, boolean isPremium, String features, String price) {
        setThemeId(themeId);
    ...
    public static Theme2 fromJSON(JSONObject object) throws JSONException {
        if (object == null)
            return null;
