...
fun lightColors(
    ...
    secondaryForeground: Color = DesignSystemAppColor.Gray40,
    secondaryBackground: Color = DesignSystemAppColor.Gray,
    tertiaryForeground: Color = DesignSystemAppColor.Gray50,
...
fun darkColors(
    ...
    secondaryBackground: Color = DesignSystemAppColor.Gray70,
    tertiaryForeground: Color = DesignSystemAppColor.Gray10,
    tertiaryBackground: Color = DesignSystemAppColor.Gray80,
    quartenaryBackground: Color = DesignSystemAppColor.Gray60,
