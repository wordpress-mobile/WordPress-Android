...
import org.wordpress.android.ui.JetpackRemoteInstallComposeViewModel.JetpackResultActionData.Action
...
import org.wordpress.android.ui.JetpackRemoteInstallComposeViewModel.Type.ERROR
import org.wordpress.android.ui.JetpackRemoteInstallComposeViewModel.Type.INSTALLED
import org.wordpress.android.ui.JetpackRemoteInstallComposeViewModel.Type.INSTALLING
import org.wordpress.android.ui.JetpackRemoteInstallComposeViewModel.Type.START
...
@HiltViewModel
class JetpackRemoteInstallComposeViewModel
@Inject constructor(
    ...
    private fun Type?.toState(): UiState {
        if (this == null) {
            return UiState.Initial(R.string.install_jetpack_continue)
        }
        return when (this) {
            START -> UiState.Initial(R.string.install_jetpack_continue)
            INSTALLING -> UiState.Installing
            INSTALLED -> UiState.Done(R.string.install_jetpack_continue)
            ERROR -> UiState.Error(
                R.string.install_jetpack_retry,
    ...
    fun connect(siteId: Int = siteModel.id) {
