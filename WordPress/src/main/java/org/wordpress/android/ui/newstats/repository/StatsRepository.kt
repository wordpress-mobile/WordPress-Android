...
class StatsRepository @Inject constructor(
     ...
     */
    fun previousPeriod(period: StatsPeriod): StatsPeriod = stepPeriod(period, direction = -1)
    ...
    fun nextPeriod(period: StatsPeriod): StatsPeriod {
        val shifted = stepPeriod(period, direction = 1)
     ...
     */
    private fun stepPeriod(period: StatsPeriod, direction: Int): StatsPeriod.Custom {
