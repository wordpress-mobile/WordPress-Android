...
class SiteDesignRecommendedDimensionProvider @Inject constructor(private val contextProvider: ContextProvider) :
    ...
    override val previewWidth: Int
        get() = contextProvider.getContext().resources.getDimensionPixelSize(R.dimen.hpp_recommended_card_width)

    override val previewHeight: Int
        get() = contextProvider.getContext().resources.getDimensionPixelSize(R.dimen.hpp_recommended_card_height)

    override val rowHeight: Int
        get() = contextProvider.getContext().resources.getDimensionPixelSize(R.dimen.hpp_recommended_row_height)
