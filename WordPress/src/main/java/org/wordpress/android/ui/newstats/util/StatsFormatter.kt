 ...
 *
 * A single-day Custom range (the result of day-level paging) renders as one date ("11 Aug"); a
 * range within one calendar month renders as "28-30 Jul"; one that crosses a month boundary
 * renders the month on both ends ("28 Jul - 3 Aug") so a span like Jul 28 - Aug 3 is no longer
 * mislabelled "28-3 Aug".
 *
