...
public class ReaderAnim {
    ...
    public static void animateLikeButton(final View target, boolean askingToLikeEh) {
        animateButton(target, askingToLikeEh ? ReaderButton.LIKE_ON : ReaderButton.LIKE_OFF);
    }
