...
@AndroidEntryPoint
class TotalCommentsDetailFragment : Fragment(R.layout.stats_detail_fragment) {
    private lateinit var swipeToRefreshHelper: SwipeToRefreshHelper

    private val viewModel: TotalCommentsDetailViewModel by viewModels()
        ...
        with(StatsDetailFragmentBinding.bind(view)) {
            with(nonNullActivity as AppCompatActivity) {
                ...
                supportActionBar?.let {
                    it.title = getString(string.stats_view_total_comments)
    ...
    private fun setupObservers(viewModel: TotalCommentsDetailViewModel) {
