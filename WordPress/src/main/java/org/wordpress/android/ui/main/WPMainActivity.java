...
public class WPMainActivity extends BaseAppCompatActivity implements
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // TODO remove this
        if (JetpackRestConnectionViewModel.Companion.canInitiateJetpackRestConnection(getSelectedSite())) {
            Intent intent = JetpackRestConnectionActivity.createIntent(this);
