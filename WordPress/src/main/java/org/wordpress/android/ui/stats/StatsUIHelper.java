    ...
    public static void reloadGroupViews(final Context ctx,
        ...
        for (int i = 0; i < groupCount; i++) {
            ...
            if (chevron != null) {
                ...
                chevron.setImageResource(R.drawable.ic_chevron_right_ff0087be_24dp);
            }
    ...
    */
    ...
    private static void setGroupChevron(final boolean isGroupExpanded, View groupView, int groupPosition, boolean animate) {
        ...
        if (animate) {
            ...
            chevron.setImageResource(isGroupExpanded ? R.drawable.ic_chevron_right_ff0087be_24dp : R.drawable.ic_chevron_down_ff0087be_24dp);
            ...
            chevron.setImageResource(isGroupExpanded ? R.drawable.ic_chevron_down_ff0087be_24dp : R.drawable.ic_chevron_right_ff0087be_24dp);
        }
    }
