...
class BloggingPromptCardSource @Inject constructor(
    ...
    private fun MediatorLiveData<BloggingPromptUpdate>.getData(
        ...
        if (selectedSite != null && selectedSite.id == siteLocalId) {
            coroutineScope.launch(bgDispatcher) {
                promptsStore.getPrompt(selectedSite, Date()).collect { result ->
    ...
    private fun MediatorLiveData<BloggingPromptUpdate>.fetchCardsAndPostErrorIfAvailable(
        coroutineScope: CoroutineScope,
        ...
        coroutineScope.launch(bgDispatcher) {
            ...
            val dateBefore10Days: Date = cal.getTime()
