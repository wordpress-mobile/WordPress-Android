...
class SiteCreationPreviewFragment : SiteCreationBaseFormFragment(),
    ...
    private fun init() {
        ...
        viewModel.start(
            requireArguments()[ARG_DATA] as SiteCreationState,
            requireArguments()[ARG_RESULT] as CreateSiteState,
        )
    }
