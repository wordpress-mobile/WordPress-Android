...
import org.wordpress.android.ui.PagePostCreationSources.POST_FROM_LIST
...
fun handlePostListAction(
    ...
    when (action) {
        ...
        is PostListAction.NewPost -> {
            ActivityLauncher.addNewPostForResult(activity, action.site, action.isPromo, POST_FROM_LIST)
        }
