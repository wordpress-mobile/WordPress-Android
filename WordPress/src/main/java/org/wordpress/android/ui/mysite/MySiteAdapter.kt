...
import org.wordpress.android.ui.mysite.cards.quicklinkribbons.QuickLinkRibbonsViewHolder
...
class MySiteAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MySiteCardAndItemViewHolder<*> {
        return when (viewType) {
            ...
            MySiteCardAndItem.Type.QUICK_LINK_RIBBONS.ordinal -> QuickLinkRibbonsViewHolder(parent, uiHelpers)
    ...
    override fun onBindViewHolder(holder: MySiteCardAndItemViewHolder<*>, position: Int) {
        when (holder) {
            ...
            is QuickLinkRibbonsViewHolder -> holder.bind(items[position] as QuickLinkRibbons)
