...
fun TimeoutState() {
    Column(
        ...
        Image(
            painter = painterResource(R.drawable.img_illustration_empty_results_216dp),
        ...
        TitleM3(
            text = stringResource(R.string.qrcode_auth_flow_timeout_title),
            textAlign = TextAlign.Center
        )
        SubtitleM3(
            text = stringResource(R.string.qrcode_auth_flow_timeout_subtitle),
            textAlign = TextAlign.Center,
...
@Composable
private fun TimeoutStatePreview() {
    AppThemeM3 {
        TimeoutState()
    }
}
