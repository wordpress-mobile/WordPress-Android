...
import org.wordpress.android.ui.newstats.util.THOUSAND
 ...
 *
 * [abbreviateFrom] is passed through to [formatStatValue] so a screen can apply one abbreviation
 * threshold to its header and its tables alike.
 */
@Composable
fun StatsLabeledValue(
    ...
    Column(modifier = modifier) {
        ...
        Text(
            text = formatStatValue(value, abbreviateFrom),
