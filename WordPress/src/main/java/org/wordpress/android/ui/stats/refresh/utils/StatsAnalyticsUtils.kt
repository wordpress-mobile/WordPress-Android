...
fun AnalyticsTrackerWrapper.trackGranularWithPeriod(stat: Stat, statsSection: StatsSection, period: Date) {
    val property = when (statsSection) {
    ...
    this.track(stat, mapOf(SECTION to property))
}
