...
public class ReaderPostListActivity1 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ReaderPostListFragment1 fragment = getListFragment();
    ...
    private void showListFragmentForTag(final ReaderTag tag, ReaderPostListType listType) {
        ...
        Fragment fragment = ReaderPostListFragment1.newInstanceForTag(tag, listType);
        getFragmentManager()
                .beginTransaction()
    ...
    private void showListFragmentForBlog(long blogId) {
        ...
        Fragment fragment = ReaderPostListFragment1.newInstanceForBlog(blogId);
        getFragmentManager()
                .beginTransaction()
                .replace(R.id.fragment_container, fragment, getString(R.string.fragment_tag_reader_post_list))
                .commit();
    ...
    private void showListFragmentForFeed(long feedId) {
        ...
        Fragment fragment = ReaderPostListFragment1.newInstanceForFeed(feedId);
        getFragmentManager()
                .beginTransaction()
                .replace(R.id.fragment_container, fragment, getString(R.string.fragment_tag_reader_post_list))
                .commit();
