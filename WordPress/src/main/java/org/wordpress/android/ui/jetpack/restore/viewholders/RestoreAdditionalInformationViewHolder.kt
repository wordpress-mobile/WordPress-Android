...
import kotlinx.android.synthetic.main.backup_list_additional_information_item.*
...
class RestoreAdditionalInformationViewHolder(
    ...
    parent: ViewGroup
) : JetpackViewHolder(R.layout.backup_list_additional_information_item, parent) {
