...
import org.wordpress.android.ui.stats.refresh.usecases.ServiceMapper.Service.FACEBOOK
import org.wordpress.android.ui.stats.refresh.usecases.ServiceMapper.Service.GOOGLE_PLUS
import org.wordpress.android.ui.stats.refresh.usecases.ServiceMapper.Service.LINKED_IN
import org.wordpress.android.ui.stats.refresh.usecases.ServiceMapper.Service.PATH
import org.wordpress.android.ui.stats.refresh.usecases.ServiceMapper.Service.TUMBLR
import org.wordpress.android.ui.stats.refresh.usecases.ServiceMapper.Service.TWITTER
...
@Inject constructor(private val resourceProvider: ResourceProvider) {
    fun map(services: List<org.wordpress.android.fluxc.model.stats.PublicizeModel.Service>): List<BlockListItem.Item> {
