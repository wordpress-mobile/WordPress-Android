...
class TotalCommentsDetailViewModel @Inject constructor(
    ...
    @Named(TOTAL_COMMENTS_DETAIL_USE_CASE) private val detailUseCase: BaseListUseCase,
    ...
    fun onPullToRefresh() {
        ...
        if (networkUtilsWrapper.isNetworkAvailable()) {
            ...
            _isRefreshing.value = false
            _showSnackbarMessage.value = SnackbarMessageHolder(UiStringRes(string.no_network_title))
        }
    }
}
