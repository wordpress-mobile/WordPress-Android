 ...
 * trashed or drafted, "Set as Homepage / Posts Page" only appear on sites whose theme shows a
 * static page on front, and Blaze requires an eligible site and a non-password-protected
 * published page.
 */
