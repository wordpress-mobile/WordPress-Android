    ...
    data class ReaderInterestsCardUiState(val interest: List<ReaderInterestUiState>) : ReaderCardUiState() {
        ...
        sealed class ChipStyle(
            ...
            object ChipStyleGreen : ChipStyle(
                chipStrokeColorResId = ReaderR.color.reader_topics_you_might_like_chip_green_stroke,
                chipFontColorResId = ReaderR.color.reader_topics_you_might_like_chip_green_font,
                chipFillColorResId = ReaderR.color.reader_topics_you_might_like_chip_green_fill
            )

            object ChipStylePurple : ChipStyle(
                chipStrokeColorResId = ReaderR.color.reader_topics_you_might_like_chip_purple_stroke,
                chipFontColorResId = ReaderR.color.reader_topics_you_might_like_chip_purple_font,
                chipFillColorResId = ReaderR.color.reader_topics_you_might_like_chip_purple_fill
            )

            object ChipStyleYellow : ChipStyle(
                chipStrokeColorResId = ReaderR.color.reader_topics_you_might_like_chip_yellow_stroke,
                chipFontColorResId = ReaderR.color.reader_topics_you_might_like_chip_yellow_font,
                chipFillColorResId = ReaderR.color.reader_topics_you_might_like_chip_yellow_fill
            )

            object ChipStyleOrange : ChipStyle(
                chipStrokeColorResId = ReaderR.color.reader_topics_you_might_like_chip_orange_stroke,
                chipFontColorResId = ReaderR.color.reader_topics_you_might_like_chip_orange_font,
                chipFillColorResId = ReaderR.color.reader_topics_you_might_like_chip_orange_fill
            )
        }
    }
