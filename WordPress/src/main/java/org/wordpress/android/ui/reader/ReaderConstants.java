...
public class ReaderConstants {
    // TODO: make sure READER_MAX_POSTS_TO_REQUEST is reset back to 20 and READER_MAX_POSTS_TO_DISPLAY back to 200
    public static final int  READER_MAX_POSTS_TO_REQUEST       = 4;     // max # posts to request when updating posts
    public static final int  READER_MAX_POSTS_TO_DISPLAY       = 20;    // max # posts to display
