...
class ActionCardGrowUseCase @Inject constructor(
    ...
    override fun buildUiModel(domainModel: Boolean): List<BlockListItem> {
        return listOf(
            ListItemActionCard(
                titleResource = R.string.stats_action_card_grow_audience_title,
                text = R.string.stats_action_card_grow_audience_message,
                positiveButtonText = R.string.stats_action_card_grow_audience_button_label,
