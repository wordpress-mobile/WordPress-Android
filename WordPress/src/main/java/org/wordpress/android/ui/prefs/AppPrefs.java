...
public class AppPrefs {
    ...
    public enum UndeletablePrefKey implements PrefKey {
        ...
        SMART_TOAST_WP_MEDIA_LONG_PRESS_USAGE_COUNTER,
        SMART_TOAST_WP_MEDIA_LONG_PRESS_TOAST_COUNTER,
        SMART_TOAST_PHOTO_PICKER_LONG_PRESS_USAGE_COUNTER,
        SMART_TOAST_PHOTO_PICKER_LONG_PRESS_TOAST_COUNTER,
