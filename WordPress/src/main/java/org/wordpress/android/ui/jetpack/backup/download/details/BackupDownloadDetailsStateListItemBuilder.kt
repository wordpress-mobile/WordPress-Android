...
class BackupDownloadDetailsStateListItemBuilder @Inject constructor() {
    ...
    private fun buildDetailsIcon() = IconState(
            ...
            contentDescription = UiStringRes(R.string.backup_download_details_icon_content_description),
    ...
    private fun buildDetailsHeader() = HeaderState(
            UiStringRes(R.string.backup_download_details_header)
    )
    ...
    private fun buildDetailsButtonAction(onClick: () -> Unit) = ActionButtonState(
            text = UiStringRes(R.string.backup_download_details_action_button),
            contentDescription = UiStringRes(R.string.backup_download_details_action_button_content_description),
            onClick = onClick
    )
