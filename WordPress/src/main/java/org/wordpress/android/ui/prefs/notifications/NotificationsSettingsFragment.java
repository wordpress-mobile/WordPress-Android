...
public class NotificationsSettingsFragment extends PreferenceFragment {
    ...
    private void addPreferencesForPreferenceScreen(PreferenceScreen preferenceScreen, Channel channel, long blogId) {
        ...
        timelinePreference.setIcon(R.drawable.ic_bell_ff87a6bc_48dp);
        ...
        emailPreference.setIcon(R.drawable.ic_mail_ff87a6bc_48dp);
        ...
        if (!TextUtils.isEmpty(deviceID)) {
            ...
            devicePreference.setIcon(R.drawable.ic_phone_ff87a6bc_48dp);
