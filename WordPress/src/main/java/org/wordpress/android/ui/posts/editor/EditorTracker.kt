...
class EditorTracker @Inject constructor(
    ...
    fun trackEditorEvent(
        ...
        val currentStat = when (event) {
            ...
            TrackableEvent.REMOVE_AS_FEATURED_BUTTON_TAPPED -> Stat.EDITOR_TAPPED_REMOVE_FEATURED
            TrackableEvent.SET_AS_FEATURED_BUTTON_TAPPED -> Stat.EDITOR_TAPPED_SET_FEATURED
