 ...
 * means approved+hold, matching the legacy ALL filter (APPROVED+UNAPPROVED). The dedicated
 * [WpApiParamCommentsStatus] variants serialise to the literal values `WP_Comment_Query` expects
