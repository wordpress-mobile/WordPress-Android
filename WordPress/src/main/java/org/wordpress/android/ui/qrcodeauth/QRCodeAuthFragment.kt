...
import org.wordpress.android.ui.barcodescanner.BarcodeScannerResultListener
...
@AndroidEntryPoint
class QRCodeAuthFragment : Fragment(), BarcodeScannerResultListener {
    @Inject
    ...
    override fun onBarcodeScanned(status: CodeScannerStatus) {
        when (status) {
