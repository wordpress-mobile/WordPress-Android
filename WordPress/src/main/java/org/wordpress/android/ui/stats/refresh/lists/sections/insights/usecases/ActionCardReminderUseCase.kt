...
class ActionCardReminderUseCase @Inject constructor(
    ...
    override fun buildUiModel(domainModel: Boolean): List<BlockListItem> {
        return listOf(
            ListItemActionCard(
                titleResource = R.string.stats_action_card_blogging_reminders_title,
                text = R.string.stats_action_card_blogging_reminders_message,
                positiveButtonText = R.string.stats_action_card_blogging_reminders_button_label,
