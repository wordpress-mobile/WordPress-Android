...
public class AutolinkUtils {
    ...
    static {
        ...
        PROVIDERS.add(Pattern.compile("(https?://((m|www)\\.)?youtube\\.com/watch\\S+)"));
        PROVIDERS.add(Pattern.compile("(https?://((m|www)\\.)?youtube\\.com/playlist\\S+)"));
        ...
        PROVIDERS.add(Pattern.compile("(https?://dai\\.ly/\\S+)"));
        ...
        PROVIDERS.add(Pattern.compile("(https?://(www\\.)?twitter\\.com/\\S+/likes$)"));
        PROVIDERS.add(Pattern.compile("(https?://(www\\.)?twitter\\.com/\\S+/lists/\\S+)"));
        PROVIDERS.add(Pattern.compile("(https?://(www\\.)?twitter\\.com/\\S+/timelines/\\S+)"));
        PROVIDERS.add(Pattern.compile("(https?://(www\\.)?twitter\\.com/i/moments/\\S+)"));
        ...
        PROVIDERS.add(Pattern.compile("(https?://(www\\.)?instagr(\\.am|am\\.com)/p/\\S+)"));
        ...
        PROVIDERS.add(Pattern.compile("(https?://(www\\.)?kickstarter\\.com/projects/\\S+)"));
        PROVIDERS.add(Pattern.compile("(https?://kck\\.st/\\S+)"));
        ...
        PROVIDERS.add(Pattern.compile("(https?://www\\.facebook\\.com/\\S+/posts/\\S+)"));
        PROVIDERS.add(Pattern.compile("(https?://www\\.facebook\\.com/\\S+/activity/\\S+)"));
        PROVIDERS.add(Pattern.compile("(https?://www\\.facebook\\.com/\\S+/photos/\\S+)"));
        PROVIDERS.add(Pattern.compile("(https?://www\\.facebook\\.com/photo(s/|\\.php)\\S+)"));
        PROVIDERS.add(Pattern.compile("(https?://www\\.facebook\\.com/permalink\\.php\\S+)"));
        PROVIDERS.add(Pattern.compile("(https?://www\\.facebook\\.com/media/\\S+)"));
        PROVIDERS.add(Pattern.compile("(https?://www\\.facebook\\.com/questions/\\S+)"));
        PROVIDERS.add(Pattern.compile("(https?://www\\.facebook\\.com/notes/\\S+)"));
        PROVIDERS.add(Pattern.compile("(https?://www\\.facebook\\.com/\\S+/videos/\\S+)"));
        PROVIDERS.add(Pattern.compile("(https?://www\\.facebook\\.com/video\\.php\\S+)"));
    }
