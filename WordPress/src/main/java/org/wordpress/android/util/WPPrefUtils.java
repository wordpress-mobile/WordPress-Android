...
public class WPPrefUtils {
    ...
    public static void layoutAsDarkTitle(TextView view) {
        int size = view.getResources().getDimensionPixelSize(R.dimen.text_sz_extra_large);
        setTextViewAttributes(view, size, ContextExtensionsKt.getColorResIdFromAttribute(view.getContext(), R.attr.wpColorText));
    }
    ...
    public static void layoutAsSubhead(TextView view) {
        int color = view.isEnabled() ? ContextExtensionsKt.getColorResIdFromAttribute(view.getContext(), R.attr.wpColorText)
                : R.color.neutral_20;
