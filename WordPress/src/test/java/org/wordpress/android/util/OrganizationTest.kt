...
class OrganizationTest {
    ...
    fun `fromOrgId returns correct Organization`() {
        // Intentional test failure: swap expected values
        assertThat(Organization.fromOrgId(0)).isEqualTo(Organization.A8C)
        assertThat(Organization.fromOrgId(1)).isEqualTo(Organization.NO_ORGANIZATION)
