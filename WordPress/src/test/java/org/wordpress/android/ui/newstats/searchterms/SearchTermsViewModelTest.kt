...
class SearchTermsViewModelTest : BaseUnitTest() {
    @Mock
    ...
    private lateinit var viewModel: SearchTermsViewModel
    ...
    private fun initViewModel() {
        viewModel = SearchTermsViewModel(
    ...
    private fun createSuccessResult() = SearchTermsResult.Success(
        items = listOf(
            SearchTermItemData(
    ...
    companion object {
        ...
        private const val TEST_ITEM_NAME_1 = "wordpress tutorial"
        private const val TEST_ITEM_NAME_2 = "how to blog"
