...
class DataViewViewModelTest {
    ...
    private open class TestableDataViewViewModel(
        ...
        // Override the init behavior to avoid the flow collection that's causing issues
        override fun initializeViewModel() {
            // Skip the parent initialization that sets up the debounce flow
            // We'll test the individual methods instead
        }
