...
class ActivityLauncherWrapperTest {
    ...
    @Test
    fun `openPlayStoreLink does not call finishAffinity when activity is finishing`() {
        val activity = mockAppPreinstalled(true)
    ...
    @Test
    fun `openPlayStoreLink does not call finishAffinity when activity is destroyed`() {
        val activity = mockAppPreinstalled(true)
