...
class PublicizeUseCaseTest : BaseUnitTest() {
    ...
    fun `maps error item to UI model`() = test {
        ...
        Assertions.assertThat(result.type).isEqualTo(FAILED)
        (result as Failed).apply {
            Assertions.assertThat(this.failedType).isEqualTo(string.stats_view_publicize)
    ...
    private suspend fun loadPublicizeModel(refresh: Boolean, forced: Boolean): InsightsItem {
