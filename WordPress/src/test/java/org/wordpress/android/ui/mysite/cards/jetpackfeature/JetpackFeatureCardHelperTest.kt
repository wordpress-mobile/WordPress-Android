...
class JetpackFeatureCardHelperTest {
    ...
    @Test
    fun `given a self-hosted site without Jetpack, then jetpack feature card should not show`() {
        setTest()
    ...
    @Test
    fun `given no selected site, then jetpack feature card should not show`() {
        setTest()
