            ...
            switch (oldDbVersion) {
                ...
                case 54:
                    ...
                    db.execSQL("CREATE TABLE WCProductModel (_id INTEGER PRIMARY KEY AUTOINCREMENT,"
                               ...
                               + "PRICE TEXT NOT NULL, PRICE_HTML TEXT NOT NULL,"
                               + "REGULAR_PRICE TEXT NOT NULL, SALE_PRICE TEXT NOT NULL,"
                               ...
                               + "SOLD_INDIVIDUALLY INTEGER,WEIGHT TEXT NOT NULL,DIMENSIONS TEXT NOT NULL,"
                               + "SHIPPING_REQUIRED INTEGER,SHIPPING_TAXABLE INTEGER,SHIPPING_CLASS TEXT NOT NULL,"
