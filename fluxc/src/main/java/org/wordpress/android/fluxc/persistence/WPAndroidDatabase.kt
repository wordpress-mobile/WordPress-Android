...
abstract class WPAndroidDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_7_8 = object : Migration(7, 8) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.apply {
                    execSQL("ALTER TABLE BloggingReminders ADD COLUMN promptCardOptedIn INTEGER NOT NULL")
                    execSQL("ALTER TABLE BloggingReminders ADD COLUMN promptRemindersOptedIn INTEGER NOT NULL")
                }
            }
        }
    }
