...
public class wpAndroid extends ListActivity {
    ...
    protected static final int[] IMAGE_IDS = {
        R.id.blavatar
    };
    ...
    public void displayAccounts() {
        ...
        if (accounts.size() > 0) {
            ...
            // start the comment service (it will kill itself if no blogs want
            // notifications)
            ...
            alarmManager.setRepeating(AlarmManager.RTC_WAKEUP, System.currentTimeMillis()
                    + (5 * 1000), UPDATE_INTERVAL, pIntent);
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                if (deleteSuccess) {
                                    ...
                                    AlertUtil.showAlert(wpAndroid.this, R.string.error,
                                            R.string.error);
                                }
                            }
                        };
    ...
    protected class HomeListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (pv == null) {
                ...
                /*
                 * if (position == 0) { usenameHeight =
                 * wrapper.getBlogUsername().getHeight(); }
                 */
                pv.setTag(wrapper);
                wrapper = new ViewWrapper(pv);
                pv.setTag(wrapper);
