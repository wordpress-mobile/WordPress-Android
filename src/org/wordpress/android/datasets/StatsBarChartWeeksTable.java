...
public class StatsBarChartWeeksTable extends SQLTable {

    private static final String NAME = "bar_chart_weeks";
    ...
    private static final class Holder {
        public static final StatsBarChartWeeksTable INSTANCE = new StatsBarChartWeeksTable();
    }

    public static synchronized StatsBarChartWeeksTable getInstance() {
        return Holder.INSTANCE;
    }

    private StatsBarChartWeeksTable() {}
    ...
    public static ContentValues getContentValues(StatsBarChartWeek stat) {
