...
val DAY_VIEW_RESPONSE_MAP =  mapOf(DATE.toString() to ViewsResponse(DAY_POST_VIEW_RESPONSE_LIST, TOTAL_VIEWS))
val DAY_POST_AND_PAGE_VIEWS_RESPONSE = PostAndPageViewsResponse(DATE, DAY_VIEW_RESPONSE_MAP, DAY_PERIOD)
...
val WEEK_VIEW_RESPONSE_MAP =  mapOf(DATE.toString() to ViewsResponse(WEEK_POST_VIEW_RESPONSE_LIST, TOTAL_VIEWS))
val WEEK_POST_AND_PAGE_VIEWS_RESPONSE = PostAndPageViewsResponse(DATE, WEEK_VIEW_RESPONSE_MAP, WEEK_PERIOD)
...
val MONTH_VIEW_RESPONSE_MAP =  mapOf(DATE.toString() to ViewsResponse(MONTH_POST_VIEW_RESPONSE_LIST, TOTAL_VIEWS))
val MONTH_POST_AND_PAGE_VIEWS_RESPONSE = PostAndPageViewsResponse(DATE, MONTH_VIEW_RESPONSE_MAP, MONTH_PERIOD)
...
val YEAR_VIEW_RESPONSE_MAP =  mapOf(DATE.toString() to ViewsResponse(YEAR_POST_VIEW_RESPONSE_LIST, TOTAL_VIEWS))
val YEAR_POST_AND_PAGE_VIEWS_RESPONSE = PostAndPageViewsResponse(DATE, YEAR_VIEW_RESPONSE_MAP, YEAR_PERIOD)
