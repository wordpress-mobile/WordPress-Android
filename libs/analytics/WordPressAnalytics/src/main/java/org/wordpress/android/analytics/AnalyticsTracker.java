...
public final class AnalyticsTracker {
    ...
    public enum Stat {
        ...
        LOGIN_EMAIL_RETRY_VIEWED,
        LOGIN_MAGIC_LINK_OPEN_FORM_VIEWED,
        LOGIN_MAGIC_LINK_REQUEST_FORM_VIEWED,
        LOGIN_PASSWORD_FORM_VIEWED,
        LOGIN_PASSWORD_RETRY_VIEWED,
        LOGIN_URL_FORM_VIEWED,
        LOGIN_URL_RETRY_VIEWED,
        LOGIN_URL_HELP_VIEWED,
        LOGIN_USERNAME_PASSWORD_FORM_VIEWED,
        LOGIN_USERNAME_PASSWORD_RETRY_VIEWED,
