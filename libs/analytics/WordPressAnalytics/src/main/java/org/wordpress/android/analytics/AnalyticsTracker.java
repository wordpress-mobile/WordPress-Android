...
public final class AnalyticsTracker {
    ...
    public enum Stat {
        ...
        STATS_VIEW_ALL_FOLLOWERS,
        STATS_VIEW_ALL_COMMENTS,
        STATS_VIEW_ALL_TAGS_AND_CATEGORIES,
        STATS_VIEW_ALL_PUBLICIZE,
        STATS_VIEW_ALL_POSTS_AND_PAGES,
        STATS_VIEW_ALL_REFERRERS,
        STATS_VIEW_ALL_CLICKS,
        STATS_VIEW_ALL_COUNTRIES,
        STATS_VIEW_ALL_VIDEO_PLAYS,
        STATS_VIEW_ALL_SEARCH_TERMS,
        STATS_VIEW_ALL_AUTHORS,
        STATS_SINGLE_POST_ACCESSED,
        STATS_TAPPED_BAR_CHART,
        STATS_TAPPED_OVERVIEW_TYPE,
        STATS_SCROLLED_TO_BOTTOM,
        STATS_WIDGET_ADDED,
        STATS_WIDGET_REMOVED,
        STATS_WIDGET_TAPPED,
        STATS_ADD_NEW_POST_TAPPED,
        STATS_SHARE_POST_TAPPED,
        STATS_VIEW_POST_DETAILS_TAPPED,
        STATS_VIEW_TAG_TAPPED,
        STATS_VIEW_AUTHORS_POST,
        STATS_VIEW_CLICK,
        STATS_VIEW_VIDEO,
        EDITOR_CREATED_POST,
