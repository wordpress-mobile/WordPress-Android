...
// FIXME: AppLockManager
public class LegacyEditorFragment extends Fragment implements TextWatcher, View.OnTouchListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mContentEditText = (EditText) rootView.findViewById(R.id.post_content);
        ...
        postSettingsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // FIXME: mActivity.showPostSettings();
            }
        });
        ...
        // FIXME: mContentEditText.setOnSelectionChangedListener(this);
        ...
        // FIXME: Move this to the Activity
        /*
        ...
        mQuickMediaType = getActivity().getIntent().getIntExtra("quick-media", -1);
        ...
        if (data != null || ((requestCode == MediaUtils.RequestCode.ACTIVITY_REQUEST_CODE_TAKE_PHOTO ||
            ...
            switch (requestCode) {
                ...
                case MediaUtils.RequestCode.ACTIVITY_REQUEST_CODE_TAKE_PHOTO:
                    if (resultCode == Activity.RESULT_OK) {
                        try {
                            ...
                            if (!addMedia(capturedImageUri, null, getActivity())) {
                                Toast.makeText(getActivity(), getResources().getText(R.string.gallery_error),
                    ...
                    } else if (mActivity != null && mQuickMediaType > -1 &&
                        ...
                        if (linkURL != null && !linkURL.equals("http://") && !linkURL.equals("")) {
                            ...
                            if (mActivity.getPost().isLocalDraft()) {
                                if (extras.getString("linkText") == null) {
                                    ...
                                    str.setSpan(new URLSpan(linkURL), mSelectionStart,
    ...
    protected void setPostContentFromShareAction() {
        ...
        if (text != null) {
            ...
            // FIXME: text = AutolinkUtils.autoCreateLinks(text);
            ...
            if (id == R.id.bold) {
                ...
                if (mSelectionEnd > mSelectionStart) {
                    if (mContentEditText.getText() != null) {
                        String selectedText =
                                mContentEditText.getText().subSequence(mSelectionStart, mSelectionEnd).toString();
            ...
            if (layout != null) {
                ...
                if (image_spans.length != 0) {
                    ...
                    if (!mediaFile.isVideo()) {
                        ...
                        AlertDialog ad =
                                new AlertDialog.Builder(getActivity()).setTitle(getString(R.string.image_settings))
                                        .setView(alertView).setPositiveButton(getString(R.string.ok),
                                        new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int whichButton) {
                                                String title =
                                                        (titleText.getText() != null) ? titleText.getText().toString() :
                                                                "";
                                                MediaFile mediaFile = span.getMediaFile();
                                                if (mediaFile == null) {
                                                    return;
                                                ...
                                                mediaFile.setHorizontalAlignment(
                                                ...
                                                if (featuredCheckBox.isChecked()) {
                                                    ...
                                                    WPImageSpan[] postImageSpans = contentSpannable
                                                            .getSpans(0, contentSpannable.length(), WPImageSpan.class);
                ...
                MediaGalleryImageSpan[] gallerySpans =
                        s.getSpans(charPosition, charPosition, MediaGalleryImageSpan.class);
                if (gallerySpans.length > 0) {
    ...
    public void onSelectionChanged() {
        ...
        Object[] spans =
                s.getSpans(mContentEditText.getSelectionStart(), mContentEditText.getSelectionStart(), Object.class);
