...
@SupportedAnnotationTypes("org.wordpress.android.annotation.Experiment", "org.wordpress.android.annotation.Feature")
class RemoteConfigProcessor : AbstractProcessor() {
    ...
    private fun generateRemoteConfigDefaults(remoteConfigDefaults: Map<String, String>) {
        ...
        val file = File(resFile, "remote_config_defaults.xml")
        if (file.exists()) {
            file.delete()
        }
        val newFile = File(resFile, "remote_config_defaults.xml")
