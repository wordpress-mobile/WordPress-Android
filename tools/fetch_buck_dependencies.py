...
BASE_DEPENDENCIES ={
'android-support-v13': {'url': os.path.join(ANDROID_SDK_PATH, 'extras/android/m2repository/com/android/support/support-v13/23.0.1/support-v13-23.0.1.aar')},
'android-support-v4': {'url': os.path.join(ANDROID_SDK_PATH, 'extras/android/m2repository/com/android/support/support-v4/23.0.1/support-v4-23.0.1.aar')},
'annotations': {'url': 'https://repo1.maven.org/maven2/com/google/code/findbugs/annotations/2.0.0/annotations-2.0.0.jar'},
'support-annotations': {'url': os.path.join(ANDROID_SDK_PATH, 'extras/android/m2repository/com/android/support/support-annotations/23.0.1/support-annotations-23.0.1.jar')},
'appcompat-v7': {'url': os.path.join(ANDROID_SDK_PATH, 'extras/android/m2repository/com/android/support/appcompat-v7/23.0.1/appcompat-v7-23.0.1.aar')},
...
'cardview-v7': {'url': os.path.join(ANDROID_SDK_PATH, 'extras/android/m2repository/com/android/support/cardview-v7/23.0.1/cardview-v7-23.0.1.aar')},
...
'design': {'url': os.path.join(ANDROID_SDK_PATH, 'extras/android/m2repository/com/android/support/design/23.0.1/design-23.0.1.aar')},
...
'helpshift': {'url': 'https://repo1.maven.org/maven2/com/helpshift/android-aar/3.12.0/android-aar-3.12.0.aar'},
...
'passcodelock': {'url': 'https://repo1.maven.org/maven2/org/wordpress/passcodelock/1.0.0/passcodelock-1.0.0.aar'},
'photoview': {'url': 'https://repo1.maven.org/maven2/com/github/chrisbanes/photoview/library/1.2.4/library-1.2.4.aar'},
'recyclerview-v7': {'url': os.path.join(ANDROID_SDK_PATH, 'extras/android/m2repository/com/android/support/recyclerview-v7/23.0.1/recyclerview-v7-23.0.1.aar')},
'simperium': {'url': 'https://repo1.maven.org/maven2/com/simperium/android/simperium/0.6.6/simperium-0.6.6.aar'},
...
'volley': {'url': 'https://repo1.maven.org/maven2/com/mcxiaoke/volley/library/1.0.19/library-1.0.19.jar'},
...
'graphview': {'url': 'https://repo1.maven.org/maven2/org/wordpress/graphview/3.4.0/graphview-3.4.0.aar'},
}
