...
class XMLRPCSerializer {
    ...
    static {
        ...
        try {
            ...
            AppLog.e(T.API, "IllegalStateException setting test serializer output stream", e);
        } catch (IOException e) {
            AppLog.e(T.API, "IOException setting test serializer output stream", e);
        }
    }
    ...
    static void serialize(XmlSerializer serializer, Object object) throws IOException {
        ...
        if (object instanceof Integer || object instanceof Short || object instanceof Byte) {
            ...
            serializer.startTag(null, TYPE_STRING).text(makeValidInputString((String) object))
    ...
    static Object deserialize(XmlPullParser parser) throws XmlPullParserException, IOException, NumberFormatException {
        ...
        if (typeNodeName.equals(TYPE_INT) || typeNodeName.equals(TYPE_I4)) {
            ...
            try {
                ...
                AppLog.e(T.API, "Can't parse Date:" + value, e);
                obj = value;
            }
